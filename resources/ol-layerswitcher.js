(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory(
        ...
        require("ol/layer/Group")
      ))
    : typeof define === "function" && define.amd
    ? define(["ol/control/Control", "ol/Observable", "ol/layer/Group"], factory)
    : (global.LayerSwitcher = factory(
        global.ol.control.Control,
        global.ol.Observable,
        global.ol.layer.Group
      ));
  ...
  class LayerSwitcher extends Control {
    ...
    static renderLayers_(map, lyr, elm, options, render) {
      ...
      for (let i = 0, l; i < lyrs.length; i++) {
        ...
        if (l.get("title")) {
          elm.appendChild(
            LayerSwitcher.renderLayer_(map, l, i, options, render)
          );
        }
      }
    }
